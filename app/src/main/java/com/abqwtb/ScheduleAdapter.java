  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (trip != null) {
      ...
      ((TextView) convertView.findViewById(R.id.schedule_time))
          .setText(DateFormat.getTimeInstance().format(scheduled.getTime()));
      ...
      ((TextView) convertView.findViewById(R.id.schedule_timer))
      ...
      TextView timer = ((TextView) convertView.findViewById(R.id.schedule_timer));
      LinearLayout.LayoutParams params = (LinearLayout.LayoutParams) timer.getLayoutParams();
      params.weight = 10.0f;
      timer.setText(getContext().getString(R.string.no_more_busses));
    }
